...
const statusStyles: Record<AccountStatusTone, AccountStatusStyle> = {
  success: {
    ...
    icon: 'bg-cp-success-bg text-cp-success-text-on-bg',
  },
  danger: {
    text: 'text-cp-error-text',
    dot: 'bg-cp-error',
    badge: 'bg-cp-error-bg text-cp-error-text-on-bg',
    icon: 'bg-cp-error-bg text-cp-error-text-on-bg',
  },
  warning: {
    text: 'text-cp-warning-text',
    dot: 'bg-cp-warning',
    badge: 'bg-cp-warning-bg text-cp-warning-text-on-bg',
    icon: 'bg-cp-warning-bg text-cp-warning-text-on-bg',
  },
  info: {
    text: 'text-cp-info-text',
    dot: 'bg-cp-info',
    badge: 'bg-cp-info-bg text-cp-info-text-on-bg',
    icon: 'bg-cp-info-bg text-cp-info-text-on-bg',
  },
  normal: {
